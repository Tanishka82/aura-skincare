  ...
  return (
    <div className='flex flex-col sm:flex-row justify-between gap-4 pt-5 sm:pt-14 min-h-[80vh] border-top'>
      ...
      <div className='flex flex-col gap-4 w-full sm:max-w-[480px]'>
        <div className='text-x1 sm:text-2xl my'>
      ...
      <div className='mt-8'>
        ...
        <div className='mt-12'>
          ...
          <div className='flex gap-3 flex-col lg:flex-row'>
            ...
            <div onClick={()=>setMethod('cod')}className='flex items-center gap-3 border p-2 px-3 cursor-pointer bg-white text-black rounded'>
          ...
          <div className='w-full text-end mt-8'>
            <button onClick={()=>navigate('/orders')}className='bg-[#ff4c4c] text-white px-16 py-3 text-sm'>PLACE ORDER</button>
          </div>
        </div>
      </div>
    </div>
