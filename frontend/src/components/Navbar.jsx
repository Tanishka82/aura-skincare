...
const Navbar = () => {
    ...
    const { setShowSearch ,getCartCount } = useContext(ShopContext); // Ensure this is imported correctly
            ...
            <div className='flex items-center gap-6'>
                ...
                <div className='group relative'>
                    ...
                    <div className='group-hover:block hidden absolute dropdown-menu right-0 pt-4'>
                        <div className='flex flex-col gap-2 w-36 py-3 px-5 bg-[#fadadd] text-gray-500 rounded'>
